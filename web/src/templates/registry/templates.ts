...
export const TEMPLATE_REGISTRY: Record<string, TemplateRegistryEntry> = {
  modern: {
    ...
    sectionLayout: {
      ...
      defaults: {
        [REGION_IDS.left]: [SECTION_IDS.summary, SECTION_IDS.work, SECTION_IDS.awards, SECTION_IDS.projects],
        [REGION_IDS.right]: [
  ...
  professional: {
    ...
    sectionLayout: {
      regionKeys: [REGION_IDS.left, REGION_IDS.right],
      defaults: {
        [REGION_IDS.left]: [SECTION_IDS.work, SECTION_IDS.projects, SECTION_IDS.involvement, SECTION_IDS.achievements],
        [REGION_IDS.right]: [
          SECTION_IDS.summary,
          SECTION_IDS.objective,
  ...
  'sidebar-left': {
    ...
    sectionLayout: {
      ...
      defaults: {
        [REGION_IDS.sidebar]: [SECTION_IDS.skills, SECTION_IDS.education, SECTION_IDS.certifications, SECTION_IDS.volunteerExp],
        [REGION_IDS.main]: [SECTION_IDS.summary, SECTION_IDS.work, SECTION_IDS.projects, SECTION_IDS.awards],
      },
    },
    sectionRules: [
      { sectionId: SECTION_IDS.skills, when: has.skillsLangFrameworks },
  ...
  'sidebar-right': {
    ...
    sectionLayout: {
      ...
      defaults: {
        ...
        [REGION_IDS.sidebar]: [SECTION_IDS.skills, SECTION_IDS.education, SECTION_IDS.certifications, SECTION_IDS.awards, SECTION_IDS.volunteerExp],
      },
    },
    sectionRules: [
      { sectionId: SECTION_IDS.summary, when: has.basicsSummary },
  ...
  'header-band': {
    ...
    sectionLayout: {
      ...
      defaults: {
        [REGION_IDS.main]: [SECTION_IDS.summary, SECTION_IDS.work, SECTION_IDS.projects],
        [REGION_IDS.sidebar]: [SECTION_IDS.skills, SECTION_IDS.tools, SECTION_IDS.education, SECTION_IDS.certifications, SECTION_IDS.awards, SECTION_IDS.volunteerExp],
      },
    },
    sectionRules: [
      { sectionId: SECTION_IDS.summary, when: has.basicsSummary },
  ...
  inspired: {
    ...
    sectionLayout: {
      regionKeys: [REGION_IDS.main, REGION_IDS.sidebar],
      defaults: {
        [REGION_IDS.main]: [SECTION_IDS.work, SECTION_IDS.projects, SECTION_IDS.education],
        [REGION_IDS.sidebar]: [SECTION_IDS.summary, SECTION_IDS.skills, SECTION_IDS.certifications, SECTION_IDS.awards, SECTION_IDS.volunteerExp],
      },
    },
    sectionRules: [
      { sectionId: SECTION_IDS.work, when: has.work },
  ...
  plain: {
    ...
    sectionLayout: {
      regionKeys: [REGION_IDS.main],
      defaults: {
        [REGION_IDS.main]: [SECTION_IDS.summary, SECTION_IDS.work, SECTION_IDS.projects, SECTION_IDS.education, SECTION_IDS.skills, SECTION_IDS.certifications, SECTION_IDS.awards, SECTION_IDS.volunteerExp],
      },
    },
    sectionRules: [
      { sectionId: SECTION_IDS.summary, when: has.basicsSummary },
  ...
  straightforward: {
    ...
    sectionLayout: {
      regionKeys: [REGION_IDS.sidebar, REGION_IDS.main],
      defaults: {
        [REGION_IDS.sidebar]: [SECTION_IDS.education, SECTION_IDS.skillsMerged, SECTION_IDS.certifications, SECTION_IDS.awards, SECTION_IDS.volunteerExp],
        [REGION_IDS.main]: [SECTION_IDS.summary, SECTION_IDS.work, SECTION_IDS.projects, SECTION_IDS.involvements],
      },
    },
    sectionRules: [
      { sectionId: SECTION_IDS.education, when: has.education },
